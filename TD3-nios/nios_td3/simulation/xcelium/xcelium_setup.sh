...
# ACDS 24.1 1077 linux 2025.07.18.10:05:58
...
# ----------------------------------------
# If nios_td3 is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                                -cdslib ./cds_libs/error_adapter_0.cds.lib                               
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/niosv_reset_controller.v"                                        -work niosv_reset_controller                         -cdslib ./cds_libs/niosv_reset_controller.cds.lib                        
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                              -cdslib ./cds_libs/avalon_st_adapter.cds.lib                             
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_rsp_mux_002.sv"                       -work rsp_mux_002                                    -cdslib ./cds_libs/rsp_mux_002.cds.lib                                   
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                                        -cdslib ./cds_libs/rsp_mux.cds.lib                                       
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                                  -cdslib ./cds_libs/rsp_demux_001.cds.lib                                 
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                                      -cdslib ./cds_libs/rsp_demux.cds.lib                                     
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                                    -cdslib ./cds_libs/cmd_mux_001.cds.lib                                   
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                                        -cdslib ./cds_libs/cmd_mux.cds.lib                                       
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_cmd_demux_002.sv"                     -work cmd_demux_002                                  -cdslib ./cds_libs/cmd_demux_002.cds.lib                                 
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                                      -cdslib ./cds_libs/cmd_demux.cds.lib                                     
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                -work intel_niosv_m_0_instruction_manager_wr_limiter -cdslib ./cds_libs/intel_niosv_m_0_instruction_manager_wr_limiter.cds.lib
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                 -work intel_niosv_m_0_instruction_manager_wr_limiter -cdslib ./cds_libs/intel_niosv_m_0_instruction_manager_wr_limiter.cds.lib
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                         -work intel_niosv_m_0_instruction_manager_wr_limiter -cdslib ./cds_libs/intel_niosv_m_0_instruction_manager_wr_limiter.cds.lib
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                -work intel_niosv_m_0_instruction_manager_wr_limiter -cdslib ./cds_libs/intel_niosv_m_0_instruction_manager_wr_limiter.cds.lib
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_router_005.sv"                        -work router_005                                     -cdslib ./cds_libs/router_005.cds.lib                                    
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_router_004.sv"                        -work router_004                                     -cdslib ./cds_libs/router_004.cds.lib                                    
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_router_002.sv"                        -work router_002                                     -cdslib ./cds_libs/router_002.cds.lib                                    
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0_router.sv"                            -work router                                         -cdslib ./cds_libs/router.cds.lib                                        
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_axi_master_ni.sv"                                  -work intel_niosv_m_0_data_manager_agent             -cdslib ./cds_libs/intel_niosv_m_0_data_manager_agent.cds.lib            
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                              -work intel_niosv_m_0_data_manager_agent             -cdslib ./cds_libs/intel_niosv_m_0_data_manager_agent.cds.lib            
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_intel_niosv_m_0_irq_mapper.sv"                          -work irq_mapper                                     -cdslib ./cds_libs/irq_mapper.cds.lib                                    
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cadence/nios_td3_intel_niosv_m_0_hart.sv"                        -work hart                                           -cdslib ./cds_libs/hart.cds.lib                                          
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_td3_irq_mapper.sv"                                          -work irq_mapper                                     -cdslib ./cds_libs/irq_mapper.cds.lib                                    
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_td3_mm_interconnect_0.v"                                    -work mm_interconnect_0                              -cdslib ./cds_libs/mm_interconnect_0.cds.lib                             
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_td3_timer_0.v"                                              -work timer_0                                        -cdslib ./cds_libs/timer_0.cds.lib                                       
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_td3_pio_0.v"                                                -work pio_0                                          -cdslib ./cds_libs/pio_0.cds.lib                                         
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_td3_onchip_memory2_0.v"                                     -work onchip_memory2_0                               -cdslib ./cds_libs/onchip_memory2_0.cds.lib                              
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_td3_intel_niosv_m_0.v"                                      -work intel_niosv_m_0                                -cdslib ./cds_libs/intel_niosv_m_0.cds.lib                               
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_td3.v"                                                                                                                                                                                               
fi
