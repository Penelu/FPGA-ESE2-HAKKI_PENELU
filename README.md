...
- **OS**: Linux (Ubuntu)
- **FPGA board**: DE10-Nano (Cyclone V – 5CSEBA6U23I7)
- **Tools**:
...
## TP1 – Quartus Tutorial (Completed)
...
⚠️ The **LED chain (chenillard)** was not fully functional, but all preliminary steps were successfully validated on hardware.

---

## Petit Projet – Écran Magique (In Progress)

We are now starting the **Écran magique** project, which aims to reproduce a digital version of the classic *Etch A Sketch* using:
- HDMI video output
...
---
## Encoder – First Implementation and Clock Issue

At the beginning of the *Écran magique* project, we modified the `telecran` top-level code to enable the use of the rotary encoder.  
...
- ✅ TP1: Quartus tutorial completed  
- 🚧 Petit projet: Écran magique – **ongoing**
